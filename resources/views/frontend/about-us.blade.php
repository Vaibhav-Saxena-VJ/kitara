...
@section('title', "About - Kitara Cloud")
        ...
        <div class="row justify-content-center mb-30-none">
            <div class="col-xl-6 col-lg-6 mb-30">
                <div class="about-content two">
                    ...
                    <p class="para">Softim is not only a globally recognized IT company but also a family filled with talented experts that help global brands, enterprises, mid-size businesses or even startups <br> with innovative solutions.</p>
            ...
            <div class="col-xl-6 col-lg-6 mb-30">
                <div class="about-thumb two">
                    <img src="{{ asset('theme') }}/assets/images/element/element-68.png" alt="element">
        ...
        <div class="row justify-content-center">
            <div class="col-xl-12">
                <div class="agency-content text-center">
                    ...
                    <h2 class="title">Softim is a digital agency that offers a wide scale of
