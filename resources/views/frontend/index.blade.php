...
<section class="banner-section two">
    ...
    <div class="banner-element-eightteen">
        <img src="{{ asset('theme') }}/assets/images/element/element-53.png" alt="element">
    </div>
    ...
    <div class="banner-element-twenty-two">
        <img src="{{ asset('theme') }}/assets/images/element/element-54.png" alt="element">
    </div>
    <div class="banner-element-twenty-three">
        <img src="{{ asset('theme') }}/assets/images/element/element-55.png" alt="element">
    </div>
    <div class="banner-element-twenty-four">
        <img src="{{ asset('theme') }}/assets/images/element/element-56.png" alt="element">
    </div>
    <div class="banner-element-twenty-six">
        <img src="{{ asset('theme') }}/assets/images/element/element-64.png" alt="element">
    </div>
    <div class="container">
                   ...
                   <div class="banner-content-header" data-aos="fade-up" data-aos-duration="1200">
                    ...
                    <div class="banner-area">
                        ...
                        <div class="banner-thumb">
                            <img src="{{ asset('theme') }}/assets/images/element/element-52.png" alt="element">
                        </div>
                    </div>
                </div>
            </div>
...
<section class="statistics-section pb-120">
    ...
    <div class="statistics-element-three">
        <img src="{{ asset('theme') }}/assets/images/element/element-26.png" alt="element">
    </div>
    <div class="container">
                ...
                <div class="statistics-item-area">
                    <div class="row mb-30-none">
                        <div class="col-xl-6 col-lg-6 col-md-6 mb-30">
                            <div class="statistics-item">
                                <div class="statistics-icon">
                                    <img src="{{ asset('theme') }}/assets/images/icon/icon-8.png" alt="icon">
                                </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 mb-30">
                            <div class="statistics-item">
                                <div class="statistics-icon">
                                    <img src="{{ asset('theme') }}/assets/images/icon/icon-9.png" alt="icon">
                                </div>
                                <div class="statistics-content">
                                    <div class="odo-area">
...
<section class="overview-section pb-120">
    <div class="overview-element">
        <img src="{{ asset('theme') }}/assets/images/element/element-24.png" alt="element">
    </div>
    <div class="container">
        <div class="row justify-content-center mb-30-none">
            <div class="col-xl-6 col-lg-6 mb-30">
                <div class="overview-thumb">
                    <img src="{{ asset('theme') }}/assets/images/element/element-61.png" alt="element">
                    <div class="overview-thumb-element">
                        <img src="{{ asset('theme') }}/assets/images/element/element-62.png" alt="element">
                    </div>
                </div>
            </div>
            <div class="col-xl-6 col-lg-6 mb-30">
...
<section class="service-section two pb-120">
    <div class="service-element-one two">
        <img src="{{ asset('theme') }}/assets/images/element/element-23.png" alt="element">
    </div>
    <div class="container">
...
<section class="project-section two">
    ...
    <div class="project-element-two two">
        <img src="{{ asset('theme') }}/assets/images/element/element-65.png" alt="element">
    </div>
            ...
            <div class="row justify-content-center mb-30-none">
                <div class="col-xl-2 offset-xl-2 col-md-12 col-lg-4 mb-30">
                    <div class="project-left-content">
                        <div class="logo-icon">
                            <img src="{{ asset('theme') }}/assets/images/fav.png" alt="favicon">
                        </div>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="project-thumb two">
                                        <img src="{{ asset('theme') }}/assets/images/project/project-3.png" alt="project">
                                ...
                                <div class="swiper-slide">
                                    <div class="project-thumb two">
                                        <img src="{{ asset('theme') }}/assets/images/project/project-4.png" alt="project">
                                        <div class="project-overlay">
                                            <div class="overlay-content">
                                                <h4 class="title"><a href="project-details.html">Brand redesign meanwhile <br> focusing product</a></h4>
                                            </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="project-thumb two">
                                        <img src="{{ asset('theme') }}/assets/images/project/project-5.png" alt="project">
                                        <div class="project-overlay">
                                            <div class="overlay-content">
                                                <h4 class="title"><a href="project-details.html">Brand redesign meanwhile <br> focusing product</a></h4>
                                            </div>
            ...
            <div class="row justify-content-center align-items-center mb-30-none">
                <div class="col-xl-6 col-lg-6 mb-30">
                    <div class="box-wrapper two">
                        ...
                        <div class="box1">
                            <div class="box-element-one">
                                <img src="{{ asset('theme') }}/assets/images/element/element-59.png" alt="element">
                            </div>
                        ...
                        <div class="box2">
                            <div class="box-element-five">
                                <img src="{{ asset('theme') }}/assets/images/element/element-16.png" alt="element">
                            </div>
                    ...
                    <div class="about-thumb">
                        <img src="{{ asset('theme') }}/assets/images/element/element-58.png" alt="element">
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 mb-30">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="brand-item">
                                    <img src="{{ asset('theme') }}/assets/images/brand/brand-1.png" alt="brand">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-item">
                                    <img src="{{ asset('theme') }}/assets/images/brand/brand-2.png" alt="brand">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-item">
                                    <img src="{{ asset('theme') }}/assets/images/brand/brand-3.png" alt="brand">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="brand-item">
                                    <img src="{{ asset('theme') }}/assets/images/brand/brand-4.png" alt="brand">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="team-slider two">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="team-item">
                                    <div class="team-thumb">
                                        <img src="{{ asset('theme') }}/assets/images/team/team-5.png" alt="team">
                            ...
                            <div class="swiper-slide">
                                <div class="team-item">
                                    <div class="team-thumb">
                                        <img src="{{ asset('theme') }}/assets/images/team/team-4.png" alt="team">
                                        <div class="team-social-area">
                                            <ul class="team-social">
                                                <li><a href="#0"><i class="fab fa-facebook-f"></i></a></li>
                                                <li><a href="#0"><i class="fab fa-twitter"></i></a></li>
                            ...
                            <div class="swiper-slide">
                                <div class="team-item">
                                    <div class="team-thumb">
                                        <img src="{{ asset('theme') }}/assets/images/team/team-6.png" alt="team">
                                        <div class="team-social-area">
                                            <ul class="team-social">
                                                <li><a href="#0"><i class="fab fa-facebook-f"></i></a></li>
                                                <li><a href="#0"><i class="fab fa-twitter"></i></a></li>
...
<section class="client-section two pb-120">
    <div class="client-element-one two">
        <img src="{{ asset('theme') }}/assets/images/element/element-66.png" alt="element">
    </div>
    <div class="client-element-two two">
        <img src="{{ asset('theme') }}/assets/images/element/element-45.png" alt="element">
    </div>
    <div class="client-element-three">
        <img src="{{ asset('theme') }}/assets/images/element/element-46.png" alt="element">
    </div>
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="row justify-content-center align-items-end mb-30-none">
                                    ...
                                    <div class="client-item">
                                        <div class="client-header">
                                            <div class="client-quote">
                                                <img src="{{ asset('theme') }}/assets/images/client/quote-2.png" alt="client">
                                            </div>
                                            <div class="client-thumb">
                                                <img src="{{ asset('theme') }}/assets/images/client/client-4.png" alt="client">
                                            </div>
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="client-item">
                                        <div class="client-header">
                                            ...
                                            <div class="client-thumb">
                                                <img src="{{ asset('theme') }}/assets/images/client/client-5.png" alt="client">
                                            </div>
                                        </div>
                                        <div class="client-content">
                                            <p>We teach martial arts because we love it — not because we want to make money on you. Unlike.</p>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 mb-30">
                    <div class="client-right-thumb">
                        <img src="{{ asset('theme') }}/assets/images/client/client-big.png" alt="client">
                        <div class="client-thumb-element">
                            <img src="{{ asset('theme') }}/assets/images/element/element-67.png" alt="element">
                        </div>
            ...
            <div class="row mb-30-none">
                <div class="col-xl-5 col-lg-5 mb-30">
                    <div class="contact-thumb">
                        <img src="{{ asset('theme') }}/assets/images/contact.png" alt="contact">
                    </div>
                </div>
...
<section class="blog-section pb-120">
    <div class="blog-element">
        <img src="{{ asset('theme') }}/assets/images/element/element-47.png" alt="element">
    </div>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-7 col-lg-8 text-center">
        ...
        <div class="row justify-content-center mb-30-none">
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mb-30">
                <div class="blog-item">
                    <div class="blog-thumb">
                        <img src="{{ asset('theme') }}/assets/images/blog/blog-1.png" alt="blog">
                    </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mb-30">
                <div class="blog-item">
                    <div class="blog-thumb">
                        <img src="{{ asset('theme') }}/assets/images/blog/blog-2.png" alt="blog">
                    </div>
                    <div class="blog-content">
                        <div class="blog-category">
                            <span>Software</span>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mb-30">
                <div class="blog-item">
                    <div class="blog-thumb">
                        <img src="{{ asset('theme') }}/assets/images/blog/blog-3.png" alt="blog">
                    </div>
                    <div class="blog-content">
                        <div class="blog-category">
                            <span>Design</span>
